...
module.exports = new LocalizedStrings({
  CN: {
    ...
    //   common
      ...
      no:"NO",
      alertTitle:"Atención",
      modifyShop:"¿Cambiarás domicilio donde retirar tu pedido?",
      confirm: "Confirmar",
      cancel: "Cancelación",
      choose: "Seleccione",
      back: "Regresar",
      ...
      agree:"Acepto",
      disagree:"No acepto",
      read_clause:"Ver términos y condiciones",

      // setting
      input_tel:"Ingrese n° del móvil",
      get_code:"Obtener cód. verificación",
      check_code:"Cód. verificación",
      input_code:"Ingrese cód. recibido",
      null_tel:'Falta ingresar número del móvil',
      null_code:'Falta ingresar código de verificación',
      verify_success:'Validación exitosa',
      code_error:'Código de verificación incorrecto',
      reset_tel:"Actualizar usuario (cambio de móvil)",
      to_friends:"Recomendar a mis amigos",
      clause:"TERMINOS Y CONDIC APP",

      // alert
      empty_car:"Su carrito de la compra está vacío, por favor seleccione primero los artículos",
      no_shop:"Elegir comercio",
      shopping_with_union:"Por favor, seleccione la alianza antes de hacer compras",
      select_union:"Por favor seleccione la alianza",
      time_out:'Tiempo de espera agotado, reinicie la aplicación.',

      // auth
      help:"AYUDA",
      click_union:'Elegí una COMUNIDAD según tu zona.',
      ...
      password_error:'Error de nombre de usuario o contraseña',
      none_user:'La cuenta no existe',
      ...
      deleteCustomerReceiverInfoFail:'Fallo en la eliminación',
      ...
      deliverMobilePhone:"Teléfono de vendedor",
      deliverAddress:"Dirección de vendedor",
      deliverShopName:'Nombre de vendedor',
      self_delivery:"Retiro en el comercio",
      common_delivery:"Envío a domicilio",
      receiverAddr_input:"Dirección de quien recibe",
      receiverPhone_input:"Teléfono de quien recibe",
      receiverName_input:"Nombre de quien recibe",
      ...
      not_deal:"Tu pedido ya está en proceso de envío! Por favor espera.",
      skip_order:"Su pedido no fue aceptado, comuníquese con su comercio.",

      have_dealed_for:"Ser",
      have_dealed_fore:"Uno solo",
      have_received:'Hemos recibido tu pedido，Estamos preparation tu pedido.',
      ...
      getClassPriceListFail:'No se pudo obtener la lista de precios',
      ...
      class:'Tipos de',
      getCommodityClassFail: "Fracaso en la adquisición de tipos de bienes",
      ...
      searching:"UN momento, por favor...",
      clearCar:'Vaciar',
      skip_to_order:"Confirmar pedido",
      skip_to_class:'Categorías',
      reach_end:"Fin de resultados",
      clear_car:'¿Seguro que quieres vaciar el carrito de compras?',
      no_service:"La hora seleccionada está fuera del horario comercial.",
      ...
      submitOrderSuccess: "¡Envío exitoso! Puedes ir a \"HISTORIAL\" para ver el estado de tu pedido.",
      ...
      time_error:'No es posible programar el pedido para menos de una hora. Reprogramación el horario.',
      getHistoryCarFail: "No se pudo obtener UN carrito de compras existente",
    //imagehead
    head:"https://supnuevo.s3.sa-east-1.amazonaws.com/",
      helpHead:"https://i.imgur.com/",
  },
